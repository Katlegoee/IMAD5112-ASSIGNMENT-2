...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnFeed.setOnClickListener {
           ...
           petHunger += 5
            txtHunger.setText(petHunger.toString())
            animateImageChange(petImage,R.drawable.eatingpet)
        }
        btnClean.setOnClickListener {
            petCleanliness += 10
            petHealth += 10
            txtClean.setText(petCleanliness.toString())
            animateImageChange(petImage,R.drawable.cleanpet)
        }
        btnHappy.setOnClickListener {
            ...
            petCleanliness -= 5
            txtHappy.setText(petHealth.toString())
            animateImageChange(petImage, R.drawable.playingdog)
        }
     }
